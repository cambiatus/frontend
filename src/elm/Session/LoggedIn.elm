        ...
        , div [ class "flex items-center float-right" ]
            ...
            , div [ class "relative z-10" ]
                [ button
                    ...
                    [ Avatar.viewNoAnchor shared.endpoints.ipfs profile_.avatar "h-8 w-8"
                ...
                , button
                    ...
                    [ Avatar.view shared.endpoints.ipfs profile_.avatar (Eos.nameToString profile_.account) "h-8 w-8"
                    ]
